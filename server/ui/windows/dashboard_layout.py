...
if __package__ in (None, "",):
    ...
    _THIS = os.path.abspath(os.path.dirname(__file__))   # .../server/ui/windows
    ...
    try:
        from server.ui.windows.block_library_layout import BlockLibraryView
    except Exception:
        # Fallback: load by path
        spec = importlib.util.spec_from_file_location(
            "server.ui.windows.block_library_layout", os.path.join(_THIS, "block_library_layout.py")
        )
        mod = importlib.util.module_from_spec(spec); spec.loader.exec_module(mod)
        BlockLibraryView = mod.BlockLibraryView

    try:
        from server.ui.widgets.grid_viewer import GridViewer
    except Exception:
        GridViewer = None
    ...
    try:
        from ..widgets.grid_viewer import GridViewer
    except Exception:
        GridViewer = None
    try:
        ...
        AutoCADWorker = None
    try:
        from ...core.library_config import LibraryConfig
    except Exception:
        from ...core.library_config import LibraryConfig
