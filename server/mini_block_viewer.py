...
try:
    # when imported as app.ui.mini_block_viewer
    from .preview_widget import BlockPreviewWidget
    from .accore_worker import AutoCADWorker
except Exception:
    # when run directly (double-click / by path)
    sys.path.append(os.path.dirname(__file__))          # <-- the real app/ui folder
    from preview_widget import BlockPreviewWidget        # noqa: E402
    from accore_worker import AutoCADWorker              # noqa: E402
